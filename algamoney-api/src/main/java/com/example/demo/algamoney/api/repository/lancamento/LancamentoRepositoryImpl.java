...
import com.example.demo.algamoney.api.model.Categoria_;
import com.example.demo.algamoney.api.model.Lancamento;
import com.example.demo.algamoney.api.model.Lancamento_;
import com.example.demo.algamoney.api.model.Pessoa_;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	public Page<ResumoLancamento> resumo(LancamentoFilter lancamentoFilter, Pageable pageable) {
		...
		criteria.select(builder.construct(ResumoLancamento.class, root.get(Lancamento_.codigo), root.get(Lancamento_.descricao),
				root.get(Lancamento_.dataVencimento), root.get(Lancamento_.dataPagamento),root.get(Lancamento_.valor), root.get(Lancamento_.tipo),
	...
	private void adicionarRestricoesDePaginacao(TypedQuery<?> query, Pageable pageable) {
		...
		int primeiroRegistroDaPagina = paginaAtual * totalRegistrosPorPag;
